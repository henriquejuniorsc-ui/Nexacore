  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-surface relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-brand-orange/20 rounded-full blur-[128px]" />
        ...
        <div className="relative flex flex-col justify-between p-12 w-full">
          ...
          <div className="max-w-md">
            ...
            <p className="text-text-secondary text-lg">
              Acesse sua conta para gerenciar sua clínica e acompanhar seus atendimentos.
            </p>
          </div>
